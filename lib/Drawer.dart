      ...
      child: Container(
        ...
        child: ListView(
          children: [
            ...
            listtilefunc('Subscribe Us', FontAwesomeIcons.solidNewspaper,
                ontap: () async {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
              ...
              showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      backgroundColor: Color.fromRGBO(18, 18, 18, 0.9),
                      title: overviewtext(
                          'This App is made by Pragati Agrahari.User can explore,get Details of latest Movies/series.TMDB API is used to fetch data.'),
                      actions: [
                        TextButton(
                            onPressed: () {
                              Navigator.pop(context);
